        ...
        {activeTab === 'referral' && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
            <div className="bg-white rounded-2xl border border-gray-light/30 shadow-sm p-5">
              ...
              <div className="flex items-center gap-2 bg-cream rounded-xl p-4">
              ...
              <button
                ...
                className="w-full mt-4 py-3 bg-gold/20 text-black-wine rounded-xl font-semibold text-sm border border-gold/40 cursor-pointer hover:bg-gold/30 transition-colors flex items-center justify-center gap-2"
              >
                <Copy size={16} />
                {copied === 'msg' ? 'Message copié !' : 'Copier message de partage'}
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-light/30 shadow-sm p-5">
              ...
              <ul className="space-y-3">
                {[
                  { friends: 1, reward: '1 mois Pro offert' },
                  { friends: 3, reward: '3 mois Pro offerts' },
                  { friends: 5, reward: '6 mois Pro offerts' },
                  { friends: 10, reward: 'Pro à vie' },
                ].map((r, i) => (
                  <li key={i} className="flex items-center justify-between py-2 border-b border-gray-light/20 last:border-0">
                    <span className="text-gray-dark">{r.friends} ami{r.friends > 1 ? 's' : ''} invité{r.friends > 1 ? 's' : ''}</span>
                    <span className="font-semibold text-burgundy-dark">{r.reward}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="bg-cream rounded-2xl border border-gray-light/30 p-4">
              <p className="text-xs font-bold text-gray-dark uppercase tracking-wide mb-2">Comment ça marche</p>
              <ol className="space-y-2 text-sm text-black-wine">
                <li>1. Partagez votre code avec vos amis</li>
                <li>2. Ils s'inscrivent et utilisent votre code</li>
                <li>3. Vous recevez tous les deux votre récompense !</li>
              </ol>
            </div>
          </motion.div>
        )}
