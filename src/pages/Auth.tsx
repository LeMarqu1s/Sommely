...
export function Auth() {
  ...
  const { signInWithGoogle, signInWithMagicLink, isAuthenticated, isLoading: authLoading } = useAuth();
        ...
        >
          ...
          <div className="rounded-3xl p-8"
            ...
            <AnimatePresence mode="wait">
              {mode === 'main' && (
                <motion.div key="main" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.3 }} className="space-y-3">
                  {/* Google */}
                  <motion.button
                ...
                <motion.div key="magic" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.3 }}>
                  {magicSent ? (
                    ...
                    <form onSubmit={handleMagicLink} className="space-y-3">
                      ...
                      <button type="button" onClick={() => switchMode('main')}
