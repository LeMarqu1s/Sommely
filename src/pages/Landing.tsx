  ...
  return (
    <div className="font-body" style={{ background: '#F5F0E8', overflowX: 'hidden' }}>
      ...
      <motion.div ref={heroRef} style={{ opacity: heroOpacity }}
        className="relative min-h-screen flex flex-col lg:flex-row items-center justify-center gap-0 overflow-hidden pt-11">

        {/* Left — text */}
        <div className="relative z-10 flex-1 flex flex-col justify-center px-6 py-16 lg:py-0 lg:pl-16 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}
          ...
          <motion.div style={{ y: imgY, scale: imgScale }} className="relative">
            ...
            <motion.div
              ...
              style={{ bottom: '18%', right: '-10%', background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(16px)', border: '1px solid rgba(255,255,255,0.8)', minWidth: 160 }}>
              <div className="flex items-center gap-2 mb-1">
                <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ background: '#722F37' }}>
                  <Zap size={12} color="white" fill="white"/>
                </div>
                <span className="text-xs font-bold" style={{ color: '#1d1d1f' }}>Score personnalisé</span>
              </div>
              <p className="font-display font-bold" style={{ fontSize: '1.8rem', color: '#722F37', letterSpacing: '-0.03em', lineHeight: 1 }}>94<span className="text-sm font-normal" style={{ color: '#6e6e73' }}>/100</span></p>
              <p className="text-xs mt-0.5" style={{ color: '#6e6e73' }}>Correspond à vos goûts</p>
            </motion.div>
          </motion.div>
        </motion.div>
      </motion.div>
