  ...
  return (
    <div className="min-h-screen bg-cream font-body" style={{ backgroundColor: '#FAF9F6' }}>
      <div className="bg-white border-b border-gray-light/30 px-6 py-4 flex items-center justify-between sticky top-0 z-20 shadow-sm">
        <button type="button" onClick={() => navigate('/home')} className="bg-transparent border-none cursor-pointer p-1">
      ...
      <div className="max-w-lg mx-auto px-6 py-12 text-center">
        ...
        <button type="button" onClick={() => navigate('/home')} className="bg-burgundy-dark text-white px-8 py-3 rounded-full font-semibold text-sm border-none cursor-pointer hover:opacity-90 transition-opacity">
          Retour à l&apos;accueil
        </button>
      </div>
    </div>
